...
from home_rental_info_scraper.spiders import klikvoorwonen,makelaarshuis,mercatus_aanbod
...
def spider_results():
    try:
        results = []
        spider_list = [klikvoorwonen.KlikvoorwonenSpider,makelaarshuis.MakelaarshuisSpider,mercatus_aanbod.MercatusAanbodSpider]
