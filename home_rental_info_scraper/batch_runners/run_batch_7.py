...
from home_rental_info_scraper.spiders import studentenenschede,svnk,thuisindeachterhoek
...
def spider_results():
    try:
        results = []
        spider_list = [studentenenschede.StudentenenschedeSpider, svnk.SvnkSpider, thuisindeachterhoek.ThuisindeachterhoekSpider]
