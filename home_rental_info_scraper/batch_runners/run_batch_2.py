...
from home_rental_info_scraper.spiders import bouwinvest,dewoningzoeker,frieslandhuurt
...
def spider_results():
    try:
        results = []
        spider_list = [bouwinvest.BouwinvestSpider,dewoningzoeker.DewoningzoekerSpider,frieslandhuurt.FrieslandhuurtSpider]
