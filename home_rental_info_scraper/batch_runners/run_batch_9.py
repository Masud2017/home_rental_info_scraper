...
from home_rental_info_scraper.spiders import thuispoortstudenten,vbo,vesteda
...
def spider_results():
    try:
        results = []
        spider_list = [thuispoortstudenten.ThuispoortstudentenSpider, vbo.VboSpider, vesteda.VestedaSpider]
