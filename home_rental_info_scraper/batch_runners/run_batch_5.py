...
from home_rental_info_scraper.spiders import mosaic_plaza,nmg,noordveluwe
...
def spider_results():
    try:
        results = []
        spider_list = [mosaic_plaza.MosaicPlazaSpider, nmg.NmgSpider, noordveluwe.NoordveluweSpider]
