...
from home_rental_info_scraper.spiders import thuisinlimburg,thuiskompas,thuispoort
...
def spider_results():
    try:
        results = []
        spider_list = [thuisinlimburg.ThuisinlimburgSpider,thuiskompas.ThuiskompasSpider, thuispoort.ThuispoortSpider]
