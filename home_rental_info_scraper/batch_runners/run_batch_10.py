...
from home_rental_info_scraper.spiders import woninghuren,woninginzicht,wooniezie
...
def spider_results():
    try:
        results = []
        spider_list = [woninghuren.WoninghurenSpider, woninginzicht.WoninginzichtSpider, wooniezie.WooniezieSpider]
