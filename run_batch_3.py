...
from home_rental_info_scraper.spiders import hollandrijnland,hwwonen,ikwilhuren
...
def spider_results():
    try:
        results = []
        spider_list = [hollandrijnland.HollandrijnlandSpider, hwwonen.HwwonenSpider, ikwilhuren.IkwilhurenSpider]
