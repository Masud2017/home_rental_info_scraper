...
from home_rental_info_scraper.spiders import woonkeusstedendriehoek,woonnet_rijnmond,woonnethaaglanden
...
def spider_results():
    try:
        results = []
        spider_list = [woonkeusstedendriehoek.WoonkeusstedendriehoekSpider, woonnet_rijnmond.WoonnetRijnmondSpider, woonnethaaglanden.WoonnethaaglandenSpider]
